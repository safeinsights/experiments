...
export class ChatViewProvider implements vscode.WebviewViewProvider {
    ...
    private _getHtmlForWebview(webview: vscode.Webview) {
        ...
        return [
            ...
            '        .user-message { background-color: #00CCCC; color: black; margin-left: 20%; }',
            '        .ai-message { background-color: #00205B; color: white; margin-right: 20%; }',
            ...
            '        .code-block { background-color: var(--vscode-textBlockQuote-background); border: 1px solid var(--vscode-textBlockQuote-border); border-radius: 4px; margin: 10px 0; overflow: hidden; }',
            '        .code-header { display: flex; justify-content: space-between; align-items: center; padding: 8px 12px; background-color: var(--vscode-editor-background); border-bottom: 1px solid var(--vscode-textBlockQuote-border); }',
            '        .code-lang { font-size: 12px; color: var(--vscode-descriptionForeground); font-weight: bold; }',
            '        .code-block pre { margin: 0; padding: 12px; overflow-x: auto; background: transparent; }',
            '        .code-block code { font-family: var(--vscode-editor-font-family); font-size: var(--vscode-editor-font-size); }',
            '        .apply-button { background-color: #007ACC; color: white; border: none; padding: 4px 8px; border-radius: 3px; cursor: pointer; font-size: 11px; }',
            '        .apply-button:hover { background-color: #005a9e; }',
            '    </style>',
            '</head>',
            '<body>',
